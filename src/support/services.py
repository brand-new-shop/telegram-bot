...
class SupportAPIClient:
    ...
    async def get_user_tickets(self, telegram_id: int) -> tuple[
        models.SupportTicketPreview, ...]:
    ...
    async def create_ticket(self,
                            support_ticket_create: models.SupportTicketCreate) -> models.SupportTicketCreated:
    ...
    async def create_reply_to_ticket(self, ticket_id: int,
                                     reply_text: str) -> models.ReplyToTicketCreated:
    ...
    async def get_reply_to_ticket(self,
                                  ticket_reply_id: int) -> models.ReplyToTicket:
